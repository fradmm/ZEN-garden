...
class EnergySystem:
    ...
    def construct_params(self):
        ...
        # renewables target
        parameters.add_parameter(name="renewables_target", index_names=["set_nodes", "set_time_steps_yearly"], doc='Parameter which specifies the renewables target', calling_class=cls)        # carbon emissions budget
...
class EnergySystemRules(GenericRule):
    ...
    def constraint_renewables_target(self):
        ...
        renewables_production = annual_production.sel(set_conversion_technologies=["photovoltaics","wind_onshore","biomass_plant"]).sum("set_conversion_technologies").sel(set_output_carriers="electricity")
