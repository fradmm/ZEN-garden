...
def main():
    ...
    for tech in r.get_system().set_conversion_technologies:
        filepath = "GF2050_1/set_technologies/set_conversion_technologies/" + tech + "/"
    ...
    for tech in r.get_system().set_storage_technologies:
        filepath = "GF2050_1/set_technologies/set_storage_technologies/" + tech + "/"
    ...
    for tech in r.get_system().set_transport_technologies:
        filepath = "GF2050_1/set_technologies/set_transport_technologies/" + tech + "/"
